...
public class St_TableActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.st_table);
		...
		new GetClass(StringDefine.getCachedUserId(mContext), StringDefine
				...
				new GetClass.SuccessCallback() {
					...
					@Override
					public void onSuccess(JSONArray ArrayClasses) {
...
//						}
						...
						for (int i = 0; i < ArrayClasses.length(); i++) {
							try {
								objClass = (JSONObject) ArrayClasses
										.get(i);
								System.out.println(objClass
								.getString(StringDefine.S_CLASSTIMELOCATION));
