...
import com.facecheck.ic.Lesson;
...
public class IqClassListViewAdapter extends BaseAdapter {
	...
	public void addList(List<Lesson> lessons) {
		...
		while(lessons.size() > 0){
			...
			System.out.println("lesson====="+lesson.getClass_name()+lesson.getClass_segmenceth());
	...
	private static Lesson getForeLesson(List<Lesson> lessons){
		...
		for(int i=0;i<lessons.size();i++){
			//System.out.println("======>======"+(lessons.get(i).getClass_segmenceth()).compareTo(foreLesson.getClass_segmenceth()));
